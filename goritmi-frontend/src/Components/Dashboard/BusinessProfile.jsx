    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <motion.div
          ...
          className="bg-whit text-gray-900 shadow-2xl rounded-xl p-5 flex flex-col items-center"
        >
          <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full border overflow-hidden bg-gray-50 mb-4">
            {preview ? (
              <img
                src={preview}
                alt="logo"
        ...
        <motion.form
          ...
          className="md:col-span-2 bg-whit text-gray-900  shadow-2xl rounded-xl p-5 sm:p-6 space-y-4"
        >
          {!editForm ? (
            <>
              <button
